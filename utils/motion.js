export const navVariants = {
  ...
  show: { opacity: 1, y: 0, transition: { type: 'spring', stiffness: 80, delay: 1 } },
};
...
export const textContainer = {
  hidden: { opacity: 0 },
  show: (i = 1) => ({ opacity: 1, transition: { staggerChildren: 0.1, delayChildren: i * 0.1 } }),
};
...
export const planetVariants = (direction) => ({
  hidden: { opacity: 0, x: direction === 'left' ? '-100%' : '100%', rotate: 120 },
  show: { opacity: 1, x: 0, rotate: 0, transition: { type: 'spring', duration: 1.8, delay: 0.5 } },
});
